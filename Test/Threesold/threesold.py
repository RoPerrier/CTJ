...
print("Accuracy")
a1, b1 = plot_regression(threesold, accuracy_acj, label="ACJ inversion error", marker='x',i=nb_values_plotted)
a2, b2 = plot_regression(threesold, accuracy_acj_Entropy, label="ACJ variant inversion error", marker='1',i=nb_values_plotted)
a3, b3 = plot_regression(threesold, accuracy_ctj, label="CTJ inversion error", marker='s',i=nb_values_plotted)
...
print("Iteration")
# Plot iteration
a1, b1 = plot_regression(threesold, iteration_acj, label="ACJ inversion error", marker='x', i=nb_values_plotted)
a2, b2 = plot_regression(threesold, iteration_acj_Entropy, label="ACJ variant inversion error", marker='1', i=nb_values_plotted)
...
a3, b3 = plot_exp_regression(threesold, iteration_ctj, label="CTJ inversion error", marker='s', i=nb_values_plotted)
...
print("Iteration")
# Plot iteration
a1, b1 = plot_exp_regression(threesold, number_of_errors_acj, label="ACJ inversion error", marker='x',i=nb_values_plotted)
a2, b2 = plot_exp_regression(threesold, number_of_errors_acj_Entropy, label="ACJ variant inversion error", marker='1',i=nb_values_plotted)
a3, b3 = plot_exp_regression(threesold, number_of_errors_ctj, label="CTJ inversion error", marker='s',i=nb_values_plotted)
